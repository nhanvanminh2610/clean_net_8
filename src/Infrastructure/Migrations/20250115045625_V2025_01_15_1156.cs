...
{
    /// <inheritdoc />
    public partial class V2025_01_15_1156 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TokenHash = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    TokenSalt = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RefreshToken_AspNetUsers_UserFId",
                        column: x => x.UserFId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
